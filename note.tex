...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{⟦}\;\Conid{S}\;\Varid{◁}\;\Conid{P}\;\Varid{⟧}\;\mathbin{:}\;\Conid{C}\;(\Conid{X},\Conid{Y})\;\to \;\Varid{⟦}\;\Conid{S}\;\Varid{◁}\;\Conid{P}\;\Varid{⟧}\;\Conid{X}\;\to \;\Varid{⟦}\;\Conid{S}\;\Varid{◁}\;\Conid{P}\;\Varid{⟧}\;\Conid{Y}{}\<[E]%
\\
...
\\
\>[3]{}\Varid{g}\;\mathbin{:}\;(\Varid{a}\;\mathbin{:}\;\Conid{S})\;\to \;\Conid{C}\;(\Conid{Q}\;(\Varid{f}\;\Varid{a}),\Conid{P}\;\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{⟦}\;(\Varid{f},\Varid{g})\;\Varid{⟧}\;\mathbin{:}\;(\Conid{X}\;\mathbin{:}\;\mathbin{/}\;\Conid{C}\;\mathbin{/})\;\to \;\Varid{⟦}\;\Conid{S}\;\Varid{◁}\;\Conid{P}\;\Varid{⟧}\;\Conid{X}\;\to \;\Varid{⟦}\;\Conid{T}\;\Varid{◁}\;\Conid{Q}\;\Varid{⟧}\;\Conid{X}{}\<[E]%
\\
...
\todoi{Explain more of how we can then specify this}
...
\\
\>[8]{}=\;\Conid{F₀-alg}\;(\Conid{L1},\Conid{U}\;\Conid{X}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[14]{}=\;\Conid{F₁'}\;(\Conid{F₀-alg}\;(\Conid{L1},\Conid{X}))\;{}\<[E]%
\\
\>[14]{}=\;(\Varid{s}\;\mathbin{:}\;\Conid{S})\;\Varid{×}\;(\Conid{P}\;\Varid{s}\;\to \;\Conid{F₀-alg}\;(\Conid{L1},\Conid{X}))\;{}\<[E]%
\\
...
directly. The following example is not expressible, as the functor \ensuremath{\mathbin{//}\;\anonymous \;\mathbin{//}\;\mathbin{:}\;\Conid{Type}\;\to \;\Conid{Type}} is not a container:
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{c}\;\mathbin{:}\;\mathbin{//}\;\Conid{T}\;\mathbin{//}\;\to \;\Conid{T}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{center}
 ...
 { \ensuremath{\Varid{f}\;(\Varid{θ}\;\Varid{x})} & & \ensuremath{\Varid{ρ}\;(\Conid{F}\;\Varid{f}\;\Varid{x})} \\
  ...
  \path[->] (m-1-3) edge[decorate] node[auto]       {\ensuremath{\Varid{ap}\;(\Varid{λ}\;\Varid{h}\;\Varid{→}\;\Varid{ρ}\;(\Conid{F}\;\Varid{h}\;\Varid{x}))\;\Varid{p}}} (m-2-3);
  \path[->] (m-1-1) edge[decorate] node[auto,swap]  {\ensuremath{\Varid{ap}\;(\Varid{λ}\;\Varid{h}\;\Varid{→}\;\Varid{h}\;(\Varid{θ}\;\Varid{x}))\;\Varid{p}}} (m-2-1);
...
\todoi{action on morphisms of \ensuremath{\Conid{G}}}
...
\begin{center}
 ...
 { \ensuremath{\Conid{G}\;\Varid{x}\;\Varid{f},\Varid{f₀}\;(\Varid{θ₁}\;\Varid{x})} & & \ensuremath{\Varid{ρ₁}\;(\Conid{F₁}\;\Varid{f}\;\Varid{x})} \\
  ...
  \path[->] (m-1-1) edge[decorate] node[auto]       {\ensuremath{\Varid{f-β₁}\;\Varid{x}}} (m-1-3);
  \path[->] (m-1-3) edge[decorate] node[auto]       {\ensuremath{\Varid{ap}\;(\Varid{λ}\;\Varid{h},\Varid{h₀}\;\Varid{→}\;\Varid{ρ₁}\;(\Conid{F}\;\Varid{h}\;\Varid{x}))\;\Varid{p},\Varid{p₀}}} (m-2-3);
  \path[->] (m-1-1) edge[decorate] node[auto,swap]  {\ensuremath{\Varid{ap}\;(\Varid{λ}\;\Varid{h},\Varid{h₀}\;\Varid{→}\;\Conid{G}\;\Varid{x}\;\Varid{h},\Varid{h₀}\;(\Varid{θ₁}\;\Varid{x})\;\Varid{p},\Varid{p₀}}} (m-2-1);
  \path[->] (m-2-1) edge[decorate] node[auto]       {\ensuremath{\Varid{g-β₁}\;\Varid{x}}} (m-2-3);
  \end{tikzpicture}
\end{center}
...
\todoi{equality of algebra morphisms}
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{m₀}\;\mathbin{:}\;(\Varid{x}\;\mathbin{:}\;\Conid{F₀}\;\Conid{T})\;\to \;\Varid{□}\;\Conid{F₀}\;\Varid{x}\;\to \;\Conid{P}\;(\Varid{c₀}\;\Varid{x}){}\<[E]%
\\
\>[3]{}\Varid{m₁}\;\mathbin{:}\;(\Varid{x}\;\mathbin{:}\;\Conid{F₁}\;\Conid{T})\;(\Varid{y}\;\mathbin{:}\;\Varid{□}\;\Conid{F₁}\;\Varid{x})\;\to \;\Varid{m₀}\;\Varid{*ᵈ}\;(\Varid{lᵈ}\;\Varid{x}\;\Varid{y})\;=\;\Varid{m₀}\;\Varid{*ᵈ}\;(\Varid{rᵈ}\;\Varid{x}\;\Varid{y})\;[\mskip1.5mu \Conid{P}\;\Varid{↓}\;\Varid{c₁}\;\Varid{x}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{m₀}\;\Varid{*ᵈ}\;\mathbin{:}\;(\Varid{x}\;\mathbin{:}\;\Conid{Σ}\;(\Conid{F₀}\;\Varid{*})\;\to \;(\Varid{□}\;(\Conid{F₀}\;\Varid{*})\;\Varid{x})\;\to \;\Conid{P}\;(\Varid{c₀}\;(\Varid{π₀}\;\Varid{x})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{step}\;\mathbin{:}\;(\Varid{x}\;\mathbin{:}\;\Varid{⟦}\;\Conid{F}\;\Varid{⟧₀}\;\Conid{T})\;\Varid{→}\;\Varid{□}\;\Conid{F}\;(\Varid{λ}\;\Varid{x}\;\to \;\Varid{f}\;\Varid{x}\;=\;\Varid{g}\;\Varid{x})\;\Varid{x}\;\Varid{→}\;\Varid{f=g-B}\;(\Varid{c}\;\Varid{x}){}\<[E]%
\\
...
where \ensuremath{\Varid{ind-hyp}\;\mathbin{:}\;(\Varid{x}\;\mathbin{:}\;\Conid{F}\;\Conid{T})\;\Varid{→}\;\Varid{□}\;\Conid{F}\;(\Varid{λ}\;\Varid{x}\;\to \;\Varid{f}\;\Varid{x}\;=\;\Varid{g}\;\Varid{x})\;\Varid{x}\;\Varid{→}\;\Conid{F}\;\Varid{f}\;\Varid{x}\;=\;\Conid{F}\;\Varid{g}\;\Varid{x}}. We can define the witness of \ensuremath{\Varid{f}\;=\;\Varid{g}} as follows:
...
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{f-β₀}\;\Varid{x}\;\Varid{∙}\;\Varid{ap}\;(\Varid{λ}\;\Varid{h}\;\Varid{→}\;\Varid{θ}\;(\Conid{F}\;\Varid{h}\;\Varid{x}))\;(\Varid{fun-ext}\;\Varid{p})\;{}\<[E]%
\\[\blanklineskip]%
\>[3]{}\hsindent{1}{}\<[4]%
...
\\[\blanklineskip]%
\>[3]{}\Varid{ap}\;(\Varid{λ}\;\Varid{h}\;\Varid{→}\;\Varid{h}\;(\Varid{c}\;\Varid{x}))\;(\Varid{fun-ext}\;\Varid{p})\;\Varid{∙}\;\Varid{g-β₀}\;\Varid{x}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
