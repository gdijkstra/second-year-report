...
\todoi{Write up examples of \onehits.}
...
constructor is a \emph{dependent} dialgebra.
...
\todoi{Write up induction principle for \onehits.}

\subsection{Algebra families}

\todoi{Write up algebra families for \onehits.}
...
\todoi{Work out circle example and show that we do not get what we expect.}

\todoi{Show that truncation is not a container itself.}
