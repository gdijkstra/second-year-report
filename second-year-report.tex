...
\todoi{Write up on status quo of HITs in Agda, refer to \texttt{HoTT-agda} library and calculating circle paper.}

\todoi{Write up on status quo of HITs in Coq.}

\todoi{Write up on status quo of HITs in Lean.}

\todoi{Wrtie up on status quo of HITs in \texttt{cubicaltt}.}
...
\todoi{Write up limitations of \onehits.}
