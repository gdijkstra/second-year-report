...
As we will talk about categorical concepts in type theory in this
report, we have to elucidate what we mean when we say \eg
``category''. 

% what is a category? aks category?

% all limits and colimits are /homotopy/ limits and colimits
\section{Overview}
\label{sec:overview}


\chapter{Syntax of higher inductive types}
\label{sec:syntax}
...
simplify to two constructors: one \zeroconstructor followed by one \oneconstructor

simplify \oneconstructor: introduce free monad
