...
show that for any $s : \Spec$, $\Alg_s$ has associativity.
...
\todoi{mention something about \omegacats segal spaces two-level type theory}
...
\todoi{simplify to two constructors: one \zeroconstructor followed by one \oneconstructor}

\todoi{simplify \oneconstructor: introduce free monad}
